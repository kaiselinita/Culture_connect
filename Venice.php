...
<head>
    ...
    <title>Venice, Italy | Culture Connect</title>
...
<main class="container py-5">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <h1 class="fw-bold mb-4">Venice, Italy</h1>
            ...
            <a href="events.php" class="btn btn-secondary px-4 py-2">Back to Events</a>
        </div>
        <div class="col-md-6 text-center">
            <img src="image/pexels-mographe-3581916.jpg" alt="Venice, Italy" class="img-fluid rounded shadow">
        </div>
    </div>
